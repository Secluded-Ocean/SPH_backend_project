...
const actions = {
  ...
  async getData({ commit }) {
    ...
    let mockData = {
      ...
      visitTotal: 88460,
      visitToday: 1234,
      visitTrend: [610, 432, 220, 534, 790, 430, 220, 320, 532, 320, 834, 690, 530, 220, 620],

      payTotal: 182425,
      payRate: 60.2,
      payTrend: [410, 82, 200, 334, 390, 330, 220, 150, 82, 200, 134, 290, 330, 150],
